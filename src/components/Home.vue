    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                <div> <a class="btn btn-social" title="Facebook" target="_blank" href="https://www.facebook.com/D4Deadlock"><i class="socicon socicon-facebook"></i></a>&nbsp;&nbsp;<a class="btn btn-social" title="Instagram" target="_blank" href="https://www.instagram.com/techkshetra2k18"><i class="socicon socicon-instagram"></i></a>      </div>
            </div>
        </div>
    </div>
</section>
